...
input = flex_m(1:lt,:);  
output = middle(1:lt,:); 
save('train_middle','input','output')

input = flex_m(lt:end,:);  
output = middle(lt:end,:); 
save('test_middle','input','output')

input = flex_in(1:lt,:);  
output = index(1:lt,:); 
save('train_index','input','output')

input = flex_in(lt:end,:);  
output = index(lt:end,:); 
save('test_index','input','output')

input1 = flex_in(1:lt,:); 
input2 = flex_th(1:lt,:);  
output = thumb(1:lt,:); 
save('train_thumb','input1','input2','output')

input1 = flex_in(lt:end,:); 
input2 = flex_th(lt:end,:);  
output = thumb(lt:end,:); 
save('test_thumb','input1','input2','output')
