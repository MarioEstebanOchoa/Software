function prediction = train_prediction_time(input, output, hidden, delay, name)

% Solve an Autoregression Problem with External Input with a NARX Neural Network
% Script generated by Neural Time Series app
% Created 23-Jul-2019 13:48:11
%
% This script assumes these variables are defined:
%
%   flex_filt - input time series.
%   real_pos - feedback time series.
...
yc = netc(xc,xic,aic);
closedLoopPerformance = perform(net,tc,yc); %UNCOMMENT TO SEE PERFORMANCE
...
multiStepPerformance = perform(net,T(1,predictOutputTimesteps),y2); %UNCOMMENT TO SEE PERFORMANCE
...
ys = nets(xs,xis,ais);
stepAheadPerformance = perform(nets,ts,ys); %UNCOMMENT TO SEE PERFORMANCE


% Generate a matrix-only MATLAB function for neural network code
% generation with MATLAB Coder tools.
genFunction(nets,name,'MatrixOnly','yes');
x1 = cell2mat(x(1,:));
x2 = cell2mat(x(2,:));
xi1 = cell2mat(xi(1,:));
xi2 = cell2mat(xi(2,:));
