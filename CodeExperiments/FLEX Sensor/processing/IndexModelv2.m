...
f = fopen([test_day_path '\index_' char(type_of_data) '.txt'],'w');
...
%%
data=dlmread([test_day_path '\index_' char(type_of_data) '.txt'],',');
...
name = [test_day_path '\mse_index_' char(type_of_data) '.txt'];
dlmwrite(name,err)
%%
end
toc()
