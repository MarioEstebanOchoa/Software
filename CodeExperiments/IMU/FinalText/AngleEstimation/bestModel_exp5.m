...
for c =1:length(fingers)
    ...
    [b_p, b_p_t ,b_target, b_estimation, b_target_t, b_estimation_t] = get_best_model(finger, Hidden(c,:), timesToTrain);
...
save('bestModelFingers_exp5','results_finger');
